...
class AwsRegionHelper(
    ...
    init {
        ...
        val credentialsProvider =
            CognitoCachingCredentialsProvider(context, IDENTITY_POOL_ID, region1)
    ...
    fun listFiles(prefix: String?, onListFilesCompleteListener: OnListFilesCompleteListener) {
        ...
        val credentialsProvider =
            CognitoCachingCredentialsProvider(context, IDENTITY_POOL_ID, Regions.fromName(REGION))
    ...
    private inner class ListFilesTask : AsyncTask<Void, Void, List<S3ObjectSummary>> {
        ...
        constructor(
            ...
            bucket: String,
            prefix: String?,
            onListFilesCompleteListener: OnListFilesCompleteListener
        ) : super() {
            this.s3 = s3
            this.bucket = bucket
            this.prefix = prefix
